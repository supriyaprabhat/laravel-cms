...
@push("after-styles")
    <link rel="stylesheet" href="{{ asset('public/assets/dashboard/css/flags.css') }}" type="text/css"/>
@endpush
@section('content')
                ...
                <div class="row">
                    ...
                    @if(Helper::GeneralWebmasterSettings("newsletter_status"))
	                	...
	                	<span class="w-40 avatar">
                            @if($Contact->photo!="")
                                <img src="{{ asset('public/uploads/contacts/'.$Contact->photo) }}"
                                     alt="{{ $Contact->first_name }} {{ $Contact->last_name }}">
                            @else
                                <img src="{{ asset('public/uploads/contacts/profile.jpg') }}"

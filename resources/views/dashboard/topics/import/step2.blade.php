...
<link rel="stylesheet" href="{{ URL::asset('public/assets/frontend/css/select2.min.css') }}?v={{ Helper::system_version() }}"/>
<link rel="stylesheet" href="{{ URL::asset('public/assets/frontend/css/select2-bootstrap.min.css') }}?v={{ Helper::system_version() }}"/>
<script src="{{ URL::asset('public/assets/frontend/js/select2.min.js') }}?v={{ Helper::system_version() }}"></script>
<script>
    $(".select2").select2();

...
@push("after-styles")
    <link href="{{ asset("public/assets/dashboard/js/dropzone/dist/min/dropzone.min.css") }}" rel="stylesheet">
...
@push("after-scripts")
    ...
    <script src="{{ asset("public/assets/dashboard/js/dropzone/dist/min/dropzone.min.js") }}"></script>

        ...
        <div class="box-body">
            @if (Session::has('relatedST'))
                @if (Session::get('relatedST') == "create")
                    ...
                    <div>
                        {{Form::open(['route'=>['topicsRelatedStore',$WebmasterSection->id,$Topic->id],'method'=>'POST' ])}}
            ...
            @else
                ...
                @endif
                @if(count($Topic->relatedTopics)>0)
                    {{Form::open(['route'=>['topicsRelatedUpdateAll',$WebmasterSection->id,$Topic->id],'method'=>'post'])}}

        ...
        <div class="box-body">
            @if (Session::has('fileST'))
                @if (Session::get('fileST') == "create")
                    <div>
                        {{Form::open(['route'=>['topicsFilesStore',$WebmasterSection->id,$Topic->id],'method'=>'POST', 'files' => true ])}}
                        ...
                        <div class="form-group row m-t-md">
                            <div class="offset-sm-2 col-sm-10">
                                ...
                                <a href="{{ route('topicsFiles',[$WebmasterSection->id,$Topic->id]) }}"
                ...
                @if (Session::get('fileST') == "edit")
                    <div>
                        {{Form::open(['route'=>['topicsFilesUpdate',$WebmasterSection->id,$Topic->id,Session::get('AttachFile')->id],'method'=>'POST', 'files' => true ])}}
                        ...
                        @foreach(Helper::languagesList() as $ActiveLanguage)
                            @if($ActiveLanguage->box_status)
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        {!! Form::text('title_'.@$ActiveLanguage->code,Session::get('AttachFile')->{'title_'.@$ActiveLanguage->code}, array('placeholder' => '','class' => 'form-control','required'=>'','maxlength'=>191, 'dir'=>@$ActiveLanguage->direction)) !!}
                                    </div>
                                </div>
                            @endif
                        @endforeach
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="col-sm-4 box p-a-xs">
                                    <a target="_blank"
                                       href="{{ asset('public/uploads/topics/'.Session::get('AttachFile')->file) }}"> {!! Helper::GetIcon(asset('public/uploads/topics/'),Session::get('AttachFile')->file) !!} {{ Session::get('AttachFile')->file }} </a>
                                </div>
                                {!! Form::file('file', array('class' => 'form-control','id'=>'files_file','accept'=>".".@str_replace(",",",.",@$allowed_file_types))) !!}
                            </div>
                        </div>
                    ...
                    <div class="row m-b">
                        <div class="col-sm-12">
                            <a class="btn btn-fw primary"
                               href="{{route("topicsFilesCreate",[$WebmasterSection->id,$Topic->id])}}">
                        ...
                        @foreach($Topic->attachFiles as $file)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ asset('public/uploads/topics/'.$file->file) }}"
                                       target="_blank">
                                        {!! Helper::GetIcon(asset('public/uploads/topics/'),$file->file) !!}
                                        {{$file->file}}</a>
                                </td>
                                <td>
                                    <small>

            ...
            <div class="row">
                @if (Session::has('mapST'))
                    ...
                    @if (Session::get('mapST') == "edit")
                        <div class="offset-sm-2 col-sm-8">
                            <br>
                            {{Form::open(['route'=>['topicsMapsUpdate',$WebmasterSection->id,$Topic->id,Session::get('Map')->id],'method'=>'POST', 'files' => true ])}}
                            ...
                            @foreach(Helper::languagesList() as $ActiveLanguage)
                                @if($ActiveLanguage->box_status)
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            {!! Form::text('title_'.@$ActiveLanguage->code,Session::get('Map')->{'title_'.@$ActiveLanguage->code}, array('placeholder' => '','class' => 'form-control','required'=>'','maxlength'=>191, 'dir'=>@$ActiveLanguage->direction)) !!}
                                        </div>
                                    </div>
                                @endif
                            @endforeach
                                ...
                                <div class="col-sm-9">
                                    <div class="radio">
                                        <label class="ui-check ui-check-md">
                                            ...
                                            <img
                                                src="{{ asset('public/assets/dashboard/images/marker_0.png')}}"
                                                style="width: 25px;">
                                        </label>
                                        <label class="ui-check ui-check-md">
                                            ...
                                            <i class="dark-white"></i>
                                            <img
                                                src="{{ asset('public/assets/dashboard/images/marker_1.png')}}"
                                                style="width: 25px;">
                                        </label>
                                        <label class="ui-check ui-check-md">
                                            ...
                                            <i class="dark-white"></i>
                                            <img
                                                src="{{ asset('public/assets/dashboard/images/marker_2.png')}}"
                                                style="width: 25px;">
                                        </label>
                                        <label class="ui-check ui-check-md">
                                            ...
                                            <i class="dark-white"></i>
                                            <img
                                                src="{{ asset('public/assets/dashboard/images/marker_3.png')}}"
                                                style="width: 25px;">
                                        </label>
                                        <label class="ui-check ui-check-md">
                                            ...
                                            <i class="dark-white"></i>
                                            <img
                                                src="{{ asset('public/assets/dashboard/images/marker_4.png')}}"
                                                style="width: 25px;">
                                        </label>
                                        <label class="ui-check ui-check-md">
                                            ...
                                            <i class="dark-white"></i>
                                            <img
                                                src="{{ asset('public/assets/dashboard/images/marker_5.png')}}"
                                                style="width: 25px;">
                                        </label>
                                        <label class="ui-check ui-check-md">
                                            ...
                                            <i class="dark-white"></i>
                                            <img
                                                src="{{ asset('public/assets/dashboard/images/marker_6.png')}}"
                                                style="width: 25px;">
                                        </label>
                                    </div>
                                </div>
                ...
                @else
                    <div>
                        <div id="mmn-{{ $Topic->id }}" class="modal fade"
                            ...
                            <div class="modal-dialog" id="animate">
                                <div class="modal-content">
                                    ...
                                    {{Form::open(['route'=>['topicsMapsStore',$WebmasterSection->id,$Topic->id],'method'=>'POST', 'files' => true ])}}
                        ...
                        <div class="col-sm-5">
                            @if(count($Topic->maps)>0)
                                {{Form::open(['route'=>['topicsMapsUpdateAll',$WebmasterSection->id,$Topic->id],'method'=>'post'])}}
                                <div>
                                        ...
                                        @foreach($Topic->maps as $map)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <img
                                                        src="{{ asset('public/assets/dashboard/images/marker_').$map->icon.".png" }}"
                                                        style="width: 20px;">
                                                    @if($title !="")
                                                        <small>{!! $title !!}</small>
                                                    @else
    ...
    @push("after-scripts")
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                ...
                var iconURLPrefix = "{{ asset('public/assets/dashboard/images/')."/" }}";
                var icons = [

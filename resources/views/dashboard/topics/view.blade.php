                                                ...
                                                <div class="row field-row {!! $customField->css_class !!}">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <video width="100%" height="450" controls>
                                                            <source src="{{ URL::to('public/uploads/topics/'.$cf_saved_val) }}"
                                                                    type="video/mp4">
                                                ...
                                                <div class="row field-row {!! $customField->css_class !!}">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        @if($ext=="mp3" || $ext=="wav")
                                                            <audio controls>
                                                                <source
                                                                    src="{{ URL::to('public/uploads/topics/'.$cf_saved_val) }}"
                                                                    type="audio/mpeg">
                                                                Your browser does not support the audio element.
                                                            </audio>
                                                        @else
                                                            <a href="{{ URL::to('public/uploads/topics/'.$cf_saved_val) }}"
                                                               target="_blank">
<span class="badge label">
    {!! Helper::GetIcon(URL::to('public/uploads/topics/'),$cf_saved_val) !!}
    {!! $cf_saved_val !!}</span>
                                                            </a>
                                                        @endif
                                                    </div>
                                            ...
                                            @elseif($customField->type ==8)
                                                ...
                                                <div class="row field-row {!! $customField->css_class !!}">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <img src="{{ URL::to('public/uploads/topics/'.$cf_saved_val) }}"
                                                             alt="{{ $cf_title }} - {{ $title }}"
                            ...
                            <div class="row">
                                @foreach($Topic->attachFiles as $attachFile)
                                    ...
                                    <div class="col-sm-3 text-center">
                                        <a href="{{ URL::to('public/uploads/topics/'.$attachFile->file) }}"
                                           target="_blank"
                                           style="padding: 10px;border: 1px solid #eee;margin-bottom: 10px;display: block;background: #f9f9f9">
                                            <strong>
                                                {!! Helper::GetIcon(URL::to('public/uploads/topics/'),$attachFile->file,40) !!}
                                                <br>
                                                &nbsp;{{ $file_title }}</strong>
                                        </a>
                                    </div>
                        ...
                        @if(count($Topic->approvedComments)>0)
                            <div class="streamline b-l m-b m-l">
                                ...
                                @foreach($Topic->approvedComments as $comment)
                                    ...
                                    <div class="sl-item">
                                        <div class="sl-left">
                                            <img src="{{ URL::to('public/uploads/contacts/profile.jpg') }}" class="img-circle">
                                        </div>
...
@endsection
@push("after-scripts")
    <script src="{{ URL::asset('public/assets/frontend/js/jquery.flexslider.js') }}"></script>
    <script>
    ...
    @if(count($Topic->maps) >0)
        ...
        <script type="text/javascript">
            ...
            var iconURLPrefix = "{{ URL::to('backEnd/public/assets/images/')."/" }}";
            var icons = [

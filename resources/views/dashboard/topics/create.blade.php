...
@push("after-styles")
    <link href="{{ asset("public/assets/dashboard/js/iconpicker/fontawesome-iconpicker.min.css") }}" rel="stylesheet">
    <!--[if lt IE 9]>
        ...
        <div class="box">
            ...
            locale:'{{ @Helper::currentLanguage()->code }}'
                ...
                @if($WebmasterSection->tags_status)
                    ...
                    @push("after-styles")
                        <link href="{{ asset("public/assets/dashboard/js/jquery-ui/jquery-ui.min.css") }}"
                              rel="stylesheet">
                        <link href="{{ asset("public/assets/dashboard/js/tags-input/tagsinput.min.css") }}"
                              rel="stylesheet">
                    @endpush
                    @push("after-scripts")
                        <script src="{{ asset("public/assets/dashboard/js/jquery-ui/jquery-ui.min.js") }}"></script>
                        <script src="{{ asset("public/assets/dashboard/js/tags-input/tagsinput.min.js") }}"></script>
                        <script>
                            $('.form-tags').tagsInput({
...
@endpush
@push("after-scripts")
    <script src="{{ asset("public/assets/dashboard/js/iconpicker/fontawesome-iconpicker.js") }}"></script>

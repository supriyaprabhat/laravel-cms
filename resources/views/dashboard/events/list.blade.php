...
@endsection
@push("before-styles")
    <link rel="stylesheet" href="{{ asset('public/assets/dashboard/js/fullcalendar/dist/fullcalendar.theme.css') }}?v={{ Helper::system_version() }}" type="text/css"/>
@endpush
@push("after-scripts")

    <script
        src="{{ asset('public/assets/dashboard/js/fullcalendar/dist/index.global.min.js') }}?v={{ Helper::system_version() }}"
        defer></script>
    <script
        src="{{ asset('public/assets/dashboard/js/fullcalendar/dist/locales/') }}/{{ @Helper::currentLanguage()->code }}.global.min.js?v={{ Helper::system_version() }}"
        defer></script>

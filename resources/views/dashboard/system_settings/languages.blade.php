                        ...
                        <select name="icon"
                            ...
                            @foreach ($Countries as $country)
                                ...
                                <option value="{{ $country->code  }}"
                                        data-data='{"image": "{{ asset('public/assets/dashboard/images/flags/'.mb_strtolower($country->code).'.svg') }}","code":"+{{ $country->tel }}","search-text":"{{ $country->{"title_" . __('backend.boxCode')} }}  +{{ $country->tel }}"}'>{{ $title }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>

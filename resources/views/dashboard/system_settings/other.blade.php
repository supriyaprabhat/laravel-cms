    ...
    <div class="p-a-md col-md-12">
        ...
        <div>
            ...
            <div class="m-x p-x {{ ($WebmasterSetting->text_editor==0)?"":"displayNone" }}" id="Summernote">
                <img src="{{ asset("public/assets/dashboard/images/Summernote.jpg") }}" alt="" class="m-t-sm m-b">
            </div>
        </div>
        <div class="m-t">
            <label class="md-check">
            ...
            <div class="m-x p-x {{ ($WebmasterSetting->text_editor==2)?"":"displayNone" }}" id="CKEditor">
                <img src="{{ asset("public/assets/dashboard/images/CKEditor.jpg") }}" alt="" class="m-t-sm m-b">
            </div>
        </div>
        <div class="m-t">
            <label class="md-check">
            ...
            <div class="m-x p-x {{ ($WebmasterSetting->text_editor==1)?"":"displayNone" }}" id="TinyMCE">
                <img src="{{ asset("public/assets/dashboard/images/TinyMCE.jpg") }}" alt="" class="m-t-sm m-b">

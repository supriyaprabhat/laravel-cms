    ...
    <div class="p-a-md col-md-12">
        ...
        <div class="form-group" id="api_key_div"
            ...
            <div class="form-control">
                <a href="http://smartfordesign.net/spreinvents/documentation/api.html"
                   class="text-info" target="_blank">http://smartfordesign.net/spreinvents/documentation/api.html</a>
            </div>

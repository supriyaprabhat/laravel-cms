        ...
        <div class="row m-t-3">
            ...
            <div class="col-md-8" id="facebook_ids_div"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('login_facebook_callbackURL',config('app.url') . '/oauth/facebook/callback', array('class' => 'form-control','readonly' => '','style'=>'font-size:12px', 'dir'=>'ltr')) !!}
                    </div>
                </div>
            </div>
        </div>
        <div class="row m-t-2">
            ...
            <div class="col-md-8" id="twitter_ids_div"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('login_facebook_callbackURL',config('app.url') . '/oauth/twitter/callback', array('class' => 'form-control','readonly' => '','style'=>'font-size:12px', 'dir'=>'ltr')) !!}
                    </div>
                </div>
            </div>
        </div>
        <div class="row m-t-2">
            ...
            <div class="col-md-8" id="google_ids_div"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('login_facebook_callbackURL',config('app.url') . '/oauth/google/callback', array('class' => 'form-control','readonly' => '','style'=>'font-size:12px', 'dir'=>'ltr')) !!}
                    </div>
                </div>
            </div>
        </div>
        <div class="row m-t-2">
            ...
            <div class="col-md-8" id="linkedin_ids_div"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('login_facebook_callbackURL',config('app.url') . '/oauth/linkedin/callback', array('class' => 'form-control','readonly' => '','style'=>'font-size:12px', 'dir'=>'ltr')) !!}
                    </div>
                </div>
            </div>
        </div>
        <div class="row m-t-2">
            ...
            <div class="col-md-8" id="github_ids_div"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('login_facebook_callbackURL',config('app.url') . '/oauth/github/callback', array('class' => 'form-control','readonly' => '','style'=>'font-size:12px', 'dir'=>'ltr')) !!}
                    </div>
                </div>
            </div>
        </div>
        <div class="row m-t-2">
            ...
            <div class="col-md-8" id="bitbucket_ids_div"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        {!! Form::text('login_facebook_callbackURL',config('app.url') . '/oauth/bitbucket/callback', array('class' => 'form-control','readonly' => '','style'=>'font-size:12px', 'dir'=>'ltr')) !!}
                    </div>
                </div>
            </div>
        </div>

                ...
                <div class="col-sm-4 col-md-3 bg b-r">
                    ...
                    <span class="w-40 avatar">
                        <a href="{{ route("contactsEdit",["id"=>$Contact->id]) }}">
                            @if($Contact->photo!="")
                                <img src="{{ asset('public/uploads/contacts/'.$Contact->photo) }}" class="img-circle">
                            @else
                                <img src="{{ asset('public/uploads/contacts/profile.jpg') }}" class="img-circle"
                                     style="opacity: 0.5">
                            @endif
                        </a>
                    </span>
                                                ...
                                                <div class="list-body">
                                                    <a href="{{ route("contactsEdit",["id"=>$Contact->id]) }}">
                                                        ...
                                                        <small class="block">
                                                            <span dir="ltr">
                                                                @if($Contact->phone !="")
                                                                    <i class="fa fa-phone m-r-sm text-muted"></i>   {{ $Contact->phone }}
                                                                @else
                                                                    <i class="fa fa-envelope-o m-r-sm text-muted"></i>  {{ $Contact->email }}
                                                                @endif
                                                            </span>
                                                        </small>
                                                    </a>

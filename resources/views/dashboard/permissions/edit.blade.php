    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#btn_update_form').submit(function (evt) {
                evt.preventDefault();
                $('#link_update_submit').html("<img src=\"{{ asset('public/assets/dashboard/images/loading.gif') }}\" style=\"height: 25px\"/> {!! __('backend.add') !!}");
            ...
            $('#btn_add_form').submit(function (evt) {
                evt.preventDefault();
                $('#btn_add_form_submit').html("<img src=\"{{ asset('public/assets/dashboard/images/loading.gif') }}\" style=\"height: 25px\"/> {!! __('backend.add') !!}");
        ...
        function list_btns() {
            $('#buttons_list').html("<div class=\"text-center\"><img class=\"m-b-1\" src=\"{{ asset('public/assets/dashboard/images/loading.gif') }}\" style=\"height: 35px;\"/></div>");
        ...
        function setToEditLink(rid) {
            ...
            $('#buttons_edit_details').html("<div class=\"text-center\"><img class=\"m-b-1\" src=\"{{ asset('public/assets/dashboard/images/loading.gif') }}\" style=\"height: 35px;\"/></div>");

...
@push("after-styles")
    <link rel="stylesheet" href="{{ asset('public/assets/dashboard/js/datatables/datatables.min.css') }}">
@endpush
@section('content')
    <div class="padding">
        <div class="box">
...
@endsection
@push("after-scripts")
    <script src="{{ asset('public/assets/dashboard/js/datatables/datatables.min.js') }}"></script>
    <script type="text/javascript">
        ...
        function UpdateTag(id) {
            ...
            btn.html("<img src=\"{{ URL::to('public/assets/dashboard/images/loading.gif') }}\" style=\"height: 20px\"/> {!! __('backend.save') !!}");
        ...
        $('#create-tag-form').submit(function (evt) {
            ...
            btn.html("<img src=\"{{ URL::to('public/assets/dashboard/images/loading.gif') }}\" style=\"height: 20px\"/> {!! __('backend.add') !!}");
            btn.prop('disabled', true);
            var formData = new FormData(this);
            var xhr = $.ajax({
                type: "POST",

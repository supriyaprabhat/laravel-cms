...
@push("after-styles")
    <link href="{{ asset("public/assets/dashboard/js/bootstrap-daterangepicker/daterangepicker-bs3.css") }}" rel="stylesheet"
          type="text/css"/>
@endpush
@section('content')
    <div class="padding">
...
@push("after-scripts")
    <script>
        let applyLabel= '{{ __('backend.apply') }}',
            fromLabel= '{{ __('backend.applyFrom') }}',
            toLabel= '{{ __('backend.applyTo') }}',
            cancelLabel= '{{ __('backend.cancel') }}',
            customRangeLabel= '{{ __('backend.customRange') }}';
    </script>
    <script src="{{ asset("public/assets/dashboard/js/bootstrap-daterangepicker/daterangepicker.js") }}"

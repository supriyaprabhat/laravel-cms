@if(Helper::GeneralWebmasterSettings("text_editor") ==2)
    <script src="{{ asset("public/assets/dashboard/js/ckeditor/ckeditor.js") }}"></script>
    <script>
        CKEDITOR.editorConfig = function (config) {
            ...
            config.contentsCss = '{{ URL::asset('public/assets/dashboard/css/bootstrap/dist/css/bootstrap.min.css') }}?v={{ Helper::system_version() }}';
...
@elseif(Helper::GeneralWebmasterSettings("text_editor") ==1)
    ...
    ?>
    <script src="//cdn.tiny.cloud/1/{{ $tiny_key }}/tinymce/5/tinymce.min.js"
    ...
    <script>
        tinymce.init({
            ...
            content_css: "{{ URL::asset('public/assets/dashboard/css/bootstrap/dist/css/bootstrap.min.css') }}?v={{ Helper::system_version() }}",

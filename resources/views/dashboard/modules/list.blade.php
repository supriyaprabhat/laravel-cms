                        ...
                        @foreach($WebmasterSections as $WebSection)
                            ...
                            <tr>
                                ...
                                <td class="text-center">{!! ($WebSection->type==5) ? "<span class='label accent'><i class='fa fa-table'></i>  ".__('backend.tableView')."</span>":"" !!}
                                    {!! ($WebSection->type==9) ? "<span class='label yellow'><i class='material-icons'>&#xe2c8;</i>  ".__('backend.documentationSection')."</span>":"" !!}
                                    {!! ($WebSection->type==8) ? "<span class='label teal'><i class='material-icons'>&#xe896;</i>  ".__('backend.accordionSection')."</span>":"" !!}
                                    {!! ($WebSection->type==7) ? "<span class='label deep-purple'><i class='material-icons'>&#xe880;</i>  ".__('backend.private2')."</span>":"" !!}
                                    {!! ($WebSection->type==6) ? "<span class='label orange'><i class='material-icons'>&#xe31f;</i>  ".__('backend.publicForm')."</span>":"" !!}

                ...
                @foreach(Helper::languagesList() as $ActiveLanguage)
                    @if($ActiveLanguage->box_status)
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                {!! Form::text('title_'.@$ActiveLanguage->code,$Banners->{'title_'.@$ActiveLanguage->code}, array('placeholder' => '','class' => 'form-control','required'=>'','maxlength'=>191, 'dir'=>@$ActiveLanguage->direction)) !!}
                            </div>
                        </div>
                    @endif
                @endforeach
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="col-sm-4 box p-a-xs">
                                                            <a target="_blank"
                                                               href="{{ asset('public/uploads/banners/'.$Banners->{"file_".$ActiveLanguage->code}) }}"><img
                                                                    src="{{ asset('public/uploads/banners/'.$Banners->{"file_".$ActiveLanguage->code}) }}"
                                            ...
                                            @else
                                                <div class="box p-a-xs">
                                                    ...
                                                    <video width="380" height="230" controls>
                                                        <source src="{{ asset('public/uploads/banners/'.$Banners->{"file_".$ActiveLanguage->code}) }}"
                                                                type="video/mp4">
                                                        Your browser does not support the video tag.
                                                    </video>
                                                    <br>
                                                    <a target="_blank"
                                                       href="{{ asset('public/uploads/banners/'.$Banners->{"file_".$ActiveLanguage->code}) }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                {!! Form::text('icon',$Banners->icon, array('autocomplete' => 'off','class' => 'form-control icp icp-auto','id'=>'icon', 'data-placement'=>'bottomRight')) !!}

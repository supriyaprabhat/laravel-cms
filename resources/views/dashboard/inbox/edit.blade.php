            ...
            <div class="box-body">
                ...
                <div class="form-group row m-t-md">
                    <div class="offset-sm-2 col-sm-10">
                        ...
                        <button type="submit" name="btn_send" onclick="document.getElementById('btn_clicked').value=''"  class="btn btn-lg btn-primary m-t"><i
                                class="material-icons">
                                &#xe31b;</i> {!! __('backend.send') !!}</button>
                        <button type="submit" name="btn_draft" onclick="document.getElementById('btn_clicked').value='draft'" class="btn btn-lg btn-default m-t"><i
                                class="material-icons">
...
@else
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="box p-a dark" style="min-height: 100px">
                <strong>{!! __('backend.sendFrom') !!}:
        ...
        <div class="col-sm-6">
            <div class="box p-a" style="min-height: 100px">
                    ...
                    <div class="row">
                        ...
                        @foreach(Session::get('WebmailToEdit')->files as $file)
                            <div class="col-sm-3">
                                ...
                                ?>
                                <a href="{{ asset('public/uploads/inbox/'.$file->file) }}"
                                ...
                                <a href="{{ asset('public/uploads/inbox/'.$file->file) }}"
                                   target="_blank"><img
                                        src="{{ asset('public/uploads/inbox/'.$file->file) }}"

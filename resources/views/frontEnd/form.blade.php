...
@if(@$FormSectionID >0)
    ...
    @if(!empty($WebmasterSection))
        ...
        @push('after-styles')
            <link rel="stylesheet"
                  href="{{ URL::asset('public/assets/frontend/vendor/datetime-picker/css/bootstrap-datetimepicker.min.css') }}?v={{ Helper::system_version() }}"/>
            <link rel="stylesheet"
                  href="{{ URL::asset('public/assets/frontend/vendor/select2/css/select2.min.css') }}?v={{ Helper::system_version() }}"/>
            @if(count($PhoneFieldsIds) >0)
                <link rel="stylesheet"
                      href="{{ URL::asset('public/assets/frontend/vendor/intl-tel-input/css/intlTelInput.min.css') }}?v={{ Helper::system_version() }}"/>
            @endif
        @endpush
        @push('after-scripts')
            <script
                    src="{{ URL::asset('public/assets/frontend/vendor/datetime-picker/js/bootstrap-datetimepicker.min.js') }}?v={{ Helper::system_version() }}"></script>
            <script
                    src="{{ URL::asset('public/assets/frontend/vendor/datetime-picker/js/locales/bootstrap-datetimepicker.'.@Helper::currentLanguage()->code.'.js') }}?v={{ Helper::system_version() }}"></script>
            <script
                    src="{{ URL::asset('public/assets/frontend/vendor/select2/js/select2.min.js') }}?v={{ Helper::system_version() }}"></script>
            @if(count($PhoneFieldsIds) >0)
                <script
                        src="{{ URL::asset('public/assets/frontend/vendor/intl-tel-input/js/intlTelInput.min.js') }}?v={{ Helper::system_version() }}"></script>
            @endif
            <script type="text/javascript">
                ...
                var iti = window.intlTelInput(document.querySelector("#customField_{{ $PhoneFieldId }}"), {
                    ...
                    utilsScript: "{{ URL::asset('public/assets/frontend/vendor/intl-tel-input/js/utils.js') }}?v={{ Helper::system_version() }}",
                });
                @endforeach
            </script>
        @endpush

...
@push('after-styles')
    <link rel="stylesheet"
          href="{{ URL::asset('public/assets/frontend/css/colors.css') }}?v={{ Helper::system_version() }}"/>
@endpush
@section('content')
    <div>
        <?php
...
@push('after-scripts')
    <script
        src="{{ URL::asset('public/assets/frontend/js/Chart.min.js') }}?v={{ Helper::system_version() }}"></script>
    <script>

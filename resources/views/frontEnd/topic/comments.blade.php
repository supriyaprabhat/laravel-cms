            ...
            <div class="card mb-3">
                @foreach($Topic->approvedComments as $comment)
                    ...
                    <div class="d-flex flex-row p-3"><img
                            src="{{ URL::to('public/uploads/contacts/profile.jpg') }}" width="40"
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#commentForm').submit(function (evt) {
                    ...
                    btn.html("<img src=\"{{ asset('public/assets/dashboard/images/loading.gif') }}\" style=\"height: 20px\"/> {!! __('frontend.sendComment') !!}");

        ...
        <a class="logo me-auto" href="{{ Helper::homeURL() }}">
            @if(Helper::GeneralSiteSettings("style_logo_" . @Helper::currentLanguage()->code) !="")
                <img alt="{{ Helper::GeneralSiteSettings("site_title_" . @Helper::currentLanguage()->code) }}"
                     src="{{ URL::to('public/uploads/settings/'.Helper::GeneralSiteSettings("style_logo_" . @Helper::currentLanguage()->code)) }}"  class="img-fluid" width="230" height="50">
            @else
                <img alt="{{ Helper::GeneralSiteSettings("site_title_" . @Helper::currentLanguage()->code) }}" src="{{ URL::to('public/uploads/settings/nologo.png') }}"  class="img-fluid"  width="172" height="50">
            @endif
        </a>
